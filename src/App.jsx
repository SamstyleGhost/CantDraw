...
const App = () => {
  ...
  return (
    ...
    <div className="sm:py-2 sm:px-8 px-4 py-8 w-full min-h-[calc(100vh)] bg-[url('./assets/SHIPSINK.svg')] bg-cover bg-center h-80 w-90">
      <div className="w-full flex justify-between items-center sm:px-8 px-4 py-4">
        ...
        {walletAddress ? (
          <p className="rounded-md font-mono font-inter font-medium bg-[#b73d37] hover:bg-[#ec5a52] text-black hover:text-white cursor-none px-4 py-2">{walletAddress}</p>
        ) : (
