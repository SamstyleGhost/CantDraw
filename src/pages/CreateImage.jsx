...
const CreateImage = () => {
    ...
    <div className='mx-10 sm:flex flex-col'>
      ...
      <h1 className="font-['Mynerve'] font-extrabold text-[#f3f3f5] text-[32px]">Can`t_Draw</h1>
        <p className="font-['Mynerve'] font-thin my-2 text-[#5887b7] text-[14px] max-w-[500px]">THEN WRITE IT</p>
      </div>
      <div>
